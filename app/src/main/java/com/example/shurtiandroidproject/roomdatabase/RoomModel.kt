...
class RoomModel(
    ...
    @ColumnInfo(name = "strIngredient16") val strIngredient16: String?,
    @ColumnInfo(name = "strIngredient17") val strIngredient17: String?,
    @ColumnInfo(name = "strIngredient18") val strIngredient18: String?,
    @ColumnInfo(name = "strIngredient19") val strIngredient19: String?,
    @ColumnInfo(name = "strIngredient20") val strIngredient20: String?,
    ...
    @ColumnInfo(name = "strMeasure10") val sstrMeasure10: String?,
    ...
    @ColumnInfo(name = "strMeasure16") val strMeasuret16: String?,
