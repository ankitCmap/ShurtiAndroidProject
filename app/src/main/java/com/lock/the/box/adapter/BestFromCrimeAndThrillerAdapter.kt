...
class BestFromCrimeAndThrillerAdapter : RecyclerView.Adapter<BestFromCrimeAndThrillerAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.best_of_crime_and_thirriler_adapter, parent, false)
