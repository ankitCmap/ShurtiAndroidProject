...
class BestSellerOfHealthBookAdapter : RecyclerView.Adapter<BestSellerOfHealthBookAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.best_seller_of_health_book_adapter, parent, false)
